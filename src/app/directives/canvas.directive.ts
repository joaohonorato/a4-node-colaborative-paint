import { Directive, ElementRef, HostListener, HostBinding, AfterViewInit } from '@angular/core';
import { v4 } from 'uuid';
...
export class CanvasDirective implements AfterViewInit {
  constructor(private el: ElementRef, private http: HttpClient, private pusher: PusherService) {
